      ...
      <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-lg bg-white p-6 rounded shadow">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            {/* Campo de senha com botão de visualização à direita apenas */}
        ...
        {userRole === 'STUDENT' && (
          <div className="mt-6 p-4 border-2 border-dashed border-gray-300 rounded-lg">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4">
              <p className="text-xs font-semibold text-blue-800 mb-1">📸 Instruções para captura:</p>
              <ul className="text-xs text-blue-700 space-y-0.5">
                <li>• Rosto totalmente visível e centralizado</li>
                <li>• Sem óculos escuros ou acessórios cobrindo o rosto</li>
                <li>• Boa iluminação e fundo neutro</li>
                <li>• Expressão neutra e olhando para a câmera</li>
                <li>• Foto nítida (não tremida ou desfocada)</li>
              </ul>
            </div>
